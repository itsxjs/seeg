...
subj_id  = 'sub001';
ratingmatrix = load(['/Users/defanive/Desktop/Diploma/SEEG_behavior/', subj_id, '_ratingmatrix.mat']);
...
for i = 1:n_events
    ...
    event_type = ratingmatrix(rate_index, 3);
    % 记录事件
    if rate_index <= 56
...
EEG = pop_reref( EEG, []);
pop_saveset(EEG, 'filename', [subj_id '_rate.set']);